...
use cubist_sdk::{core::{Cubist, Contract, TargetProject}, Http, Ws, CubistSdkError};
...
impl<M: Middleware, T> Deployable<M, T> {
        ...
        TArgs: Tokenize,
    {
        ...
        Ok((self.factory)(address, client))
    }
...
impl<M: Middleware> {{c.struct_name}}<M> {
    ...
    pub fn {{target | lower}}_address(&self) -> Address {
    ...
    pub fn try_get_{{target | lower}}_address(&self) -> Option<Address> {
