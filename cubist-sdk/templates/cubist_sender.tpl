...
contract {{contract.contract}} {
    ...
    function {{function.name}}({{macros::params(args=function.params)}}) public onlyCaller {
        emit __cubist_event_{{contract.contract}}_{{function.name}}({{macros::args(args=function.params)}});
    }
{% endfor %}
}
{% endfor %}
