...
contract EthStorage {
    ...
    event __cubist_event_EthStorage_storePayable(uint256 num);
    function storePayable(uint256 num) public onlyCaller payable {
        emit __cubist_event_EthStorage_storePayable(num);
    }
