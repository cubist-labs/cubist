...
bridge providers like Axelar which you'll be able to use with by just modifying
the configuration.
...
# Simple example: cross-chain storage

To start, let's say we want to build the simplest possible cross-chain app that
simply stores a value (`uint256`) across two contracts. First, let's create an
...
```typescript
import { Target, Cubist, } from '@cubist-alpha/cubist'
...
```typescript
import { Cubist, } from '@cubist-alpha/cubist'
import assert from 'assert';
...
[Cubist]: ./classes/Cubist.html
[getContractFactory]: ./classes/Cubist.html#getContractFactory
[getContract]: ./classes/Cubist.html#getContract
[whenBridged]: ./classes/Cubist.html#whenBridged

[ContractFactory]: ./classes/ContractFactory.html
[deploy]: ./classes/ContractFactory.html#deploy
[deployed]: ./classes/ContractFactory.html#deployed
[attach]: ./classes/ContractFactory.html#attach

[Contract]: ./classes/Contract.html

[TestDK]: ./classes/TestDK.html

[CubistCLI]: https://todo
[CubistConfig]: https://todo
[RustSDK]: https://todo
...
[^ref-config]: Refer to [CubistConfig] for details on how to configure a Cubist
  dApp and assign contracts to different chains.
